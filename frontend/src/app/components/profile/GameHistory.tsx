          ...
          <table className="w-full">
            ...
            {/* <tbody >
              <tr className="text-center even:bg-[#0C0914] ">
                <td className={`flex ${NeuePlakFont.className} text-[14px] sm:text-[18px] lg:text-[22px] xl:text-[24px] 2xl:text-[35px] p-2 xl:p-3 2xl:p-5 gap-1 md:gap-5 items-center`}>
                  <Image
