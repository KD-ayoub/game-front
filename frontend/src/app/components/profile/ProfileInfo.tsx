      ...
      <div className="w-auto h-[222px] md:h-[185px] lg:h-[222px] xl:h-[265px] 2xl:h-[320px] relative">
        ...
        <div className="md:w-full md:h-full md:relative">
          ...
          <div className="hidden md:block md:w-[70%] md:h-24 md:absolute md:left-[27%] 2xl:left-[22%] md:top-3 ">
            <p className={`${NeuePlakFont.className} text-[16px] lg:text-[18px] xl:text-[22px] 2xl:text-[30px] text-[#E95A3A]`}>
              at game
            </p>
            <div className="md:w-full md:h-10">
              <p className={`${NeuePlakFont.className} text-[9px] lg:text-[11px] xl:text-[14px] 2xl:text-[20px] text-end`}>
                80%
              </p>
              <div>
              ...
              <div className="md:flex md:justify-between">
                <div className="flex flex-col justify-start">
                  <p className={`${NeuePlakFont.className} md:text-[14px] lg:text-[18px] xl:text-[22px] 2xl:text-[28px] md:text-[#717273]`}>Friends</p>
                  <p className={`${NeuePlakFont.className} md:text-[10px] lg:text-[14px] xl:text-[18px] 2xl:text-[24px] md:text-center`}>500</p>
                </div>
                <button
